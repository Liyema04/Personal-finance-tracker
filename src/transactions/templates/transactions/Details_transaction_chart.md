...
- I can create a small external JS file (static/js/senti-chart.js) and move the inline script there.
- I can add an example unit test (Selenium or Playwright) to verify the chart renders with correct center text.
- I can make a minimal, copy-paste-ready version of drawArc/drawRoundCaps if you want to extract to shared helper.

That's it — simple, reliable, and easy to tweak.// filepath: c:\Users\liyem\.vscode\Django\Personal Finance Tracker  (Web App)\Personal-finance-tracker\src\transactions\README-chart.md
